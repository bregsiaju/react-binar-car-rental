...
import cargambar from './images/car01.min.jpg';

const CarResult = () => {
  return (
    <div class="container mt-5 col-md-9">
      <div id="cars-container" class="row row-cols-lg-3 row-cols-sm-2 row-cols-1 g-3">
        <div class="search-card">
          <div class="card p-2 mb-2 h-100">
            <div class="card-body">
              <div class="image-card ">
                <img src={cargambar} class="w-100 m-0" alt="" />
              </div>
              <div>
                <p class="mt-4">manufacture/type</p>
              </div>
              <div>
                <h5 class="fw-bold">{new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", }).format(1000000)} / hari</h5>
              </div>
              <div>
            ...
            <MyButton class="mt-4">Pilih Mobil</MyButton>
          </div>
        </div>
      </div>
    </div>
